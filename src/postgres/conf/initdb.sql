...
CREATE TABLE albums(uuid UUID DEFAULT uuid_generate_v4 () PRIMARY KEY, artist_name VARCHAR(150) NOT NULL, album_title VARCHAR(150) NOT NULL, release_date INT NOT NULL, price FLOAT NOT NULL);
